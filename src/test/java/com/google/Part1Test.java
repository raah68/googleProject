...
public class Part1Test extends TestBase {
  ...
  public void testShowAllVideos() {
    ...
    assertThat(lines[1], containsString("Amazing Cats (amazing_cats_video_id) [#cat #animal]"));
    assertThat(lines[2], containsString("Another Cat Video (another_cat_video_id) [#cat #animal]"));
    assertThat(lines[3], containsString("Funny Dogs (funny_dogs_video_id) [#dog #animal]"));
    assertThat(lines[4], containsString("Life at Google (life_at_google_video_id) [#google #career]"));
    assertThat(lines[5], containsString("Video about nothing (nothing_video_id) []"));
  }
